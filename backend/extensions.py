...
# import valkey  # Redis functionality commented out
# import ssl     # Redis functionality commented out
...
mail = Mail()
socketio = SocketIO()
# redis_client = None  # Redis functionality commented out

# def init_redis(app):  # Redis functionality commented out
